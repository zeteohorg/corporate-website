...
INS (Inertial Navigation Systems) tracks object positions using accelerometers and gyroscopes. This technology is commonly used in boats, submarines, and aircraft. However, as sensors (especially MEMS) and wearable devices have become both cheaper and more accurate, PDR (Pedestrian Dead Reckoning) has emerged as an alternative to beacon-based indoor positioning systems.
